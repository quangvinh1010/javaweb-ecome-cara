<%-- 
    Document   : sidebar
    Created on : 21 thg 9, 2024, 13:52:26
    Author     : 22 STORE
--%>
...
<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-light navbar-light">
        ...
        <div class="navbar-nav w-100">
            <a href="DashboardServlet" class="nav-item nav-link active">
                <i class="fa fa-tachometer-alt me-2"></i>Dashboard
            </a>
            <div class="nav-item dropdown">
                <a href="IndexUserServlet" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
            ...
            <div class="nav-item dropdown">
                <a href="IndexProductServlet" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
            ...
            <div class="nav-item dropdown">
                <a href="IndexOrderServlet" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
